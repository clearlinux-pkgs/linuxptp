...
Source0  : https://sourceforge.net/projects/linuxptp/files/v3.1/linuxptp-3.1.1.tgz
...
%prep
%setup -q -n linuxptp-3.1.1
cd %{_builddir}/linuxptp-3.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626107526
...
cp %{_builddir}/linuxptp-3.1.1/COPYING %{buildroot}/usr/share/package-licenses/linuxptp/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
