...
Version  : 3.0
Release  : 5
URL      : https://sourceforge.net/projects/linuxptp/files/v3.0/linuxptp-3.0.tgz
Source0  : https://sourceforge.net/projects/linuxptp/files/v3.0/linuxptp-3.0.tgz
...
%prep
%setup -q -n linuxptp-3.0
cd %{_builddir}/linuxptp-3.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595529840
...
cp %{_builddir}/linuxptp-3.0/COPYING %{buildroot}/usr/share/package-licenses/linuxptp/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
