...
Source0  : https://sourceforge.net/projects/linuxptp/files/v4.0/linuxptp-4.0.tgz
...
%prep
%setup -q -n linuxptp-4.0
cd %{_builddir}/linuxptp-4.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687296935
