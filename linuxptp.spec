...
Source0  : https://sourceforge.net/projects/linuxptp/files/v4.1/linuxptp-4.1.tgz
...
%prep
%setup -q -n linuxptp-4.1
cd %{_builddir}/linuxptp-4.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700000501
